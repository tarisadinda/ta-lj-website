    ...
    return(<>
        <div className={styles.colWrap}>
           <CustomCard sx={{ padding: '30px' }}>
                <h4 className='d-flex justify-content-center mb-5'><b>Edit Lowongan Kerja</b></h4>
            ...
            <CustomCard sx={{ padding: '20px', height: 'max-content' }}>
                <div className={styles.jobDetail}>
                    <div className={styles.iconWrap}>
                        <WorkIcon sx={{ color: '#FDFDFD' }} />
                    </div> 
                    <div>
                        <h4><b>Web Developer</b></h4>
                        <p className='mb-1'>Teknologi</p>
                        <p className='mb-1'>Work From Office - Level 1</p>
                    </div> 
                </div>
            </CustomCard> 
        </div>
